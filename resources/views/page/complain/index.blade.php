        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-none d-md-flex align-items-center gap-2 mb-3 mb-md-0">
                    <label for="statusFilter" class="mb-0 fw-semibold fs-6"><i class="ph-bold ph-funnel"></i> Filter
                        Status:</label>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white fs-6 fs-md-5" id="complineModalLabel">Create complain</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('complain-form.store') }}" method="POST" data-mode="create" data-id=""
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h5 class="text-primary fs-6 fs-md-5"><strong>Common Information</strong></h5>
                                <hr>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-6">
                                <label for="customer_id" class="form-label fs-6 fs-md-5"><strong>Customer Name
                                        :</strong></label>
                                <select name="customer_id" id="customer_id"
                                    class="form-select form-select-sm form-select-md-normal">
                                </select>
                                <div data-error-for="customer_id" class="text-danger mt-1 error-message fs-6 fs-md-5">
                                </div>
                            </div>
                            <div class="col-6">
                                <label for="customer_address" class="form-label fs-6 fs-md-5"><strong>Customer Address
                                        :</strong></label>
                                <textarea class="form-control form-control-sm form-control-md-normal" id="customer_address" name="customer_address"
                                    rows="2" readonly></textarea>
                                <div data-error-for="customer_address"
                                    class="text-danger mt-1 error-message fs-6 fs-md-5"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-12 col-md-6 col-lg-3">
                                <label for="rs_number" class="form-label fs-6 fs-md-5"><strong>Nomor RS
                                        :</strong></label>
                                <h5 id="rs_number_display" class="form-control-plaintext fs-6 fs-md-5"
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <label for="account" class="form-label fs-6 fs-md-5"><strong>Account
                                        :</strong></label>
                                <h5 id="account_display" class="form-control-plaintext fs-6 fs-md-5"
                                    style="font-weight: bold; text-align: center; border: 1px solid #dee2e6; border-radius: 0.375rem; padding: 0.375rem 0.75rem; background-color: #f8f9fa;">
                                </h5>
                                <input type="hidden" class="form-control" id="account" name="account">
                            </div>
                            <div class="col-12 col-md-6 col-lg-3">
                                <label for="date" class="form-label fs-6 fs-md-5"><strong>Tanggal
                                        :</strong></label>
                                <input type="date" class="form-control form-control-sm form-control-md-normal"
                                    id="date" name="date" value="{{ date('Y-m-d') }}">
                                <div data-error-for="date" class="text-danger mt-1 error-message fs-6 fs-md-5"></div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3">
                                <label for="cost_center" class="form-label fs-6 fs-md-5"><strong>Cost Center
                                        :</strong></label>
                                <input type="text" class="form-control form-control-sm form-control-md-normal"
                                    id="cost_center" name="cost_center">
                                <div data-error-for="cost_center" class="text-danger mt-1 error-message fs-6 fs-md-5">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <label for="objectives" class="form-label fs-6 fs-md-5"><strong>Reason for Replacement
                                        :</strong></label>
                                <textarea name="objectives" id="objectives" class="form-control form-control-sm form-control-md-normal"
                                    rows="3"></textarea>
                                <div data-error-for="objectives" class="text-danger mt-1 error-message fs-6 fs-md-5">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h5 class="text-primary fs-6 fs-md-5"><strong>Product Details</strong></h5>
                                <hr>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="requisition_items" class="form-label fs-6 fs-md-5"><strong>Select Products
                                        :</strong></label>
                                <select name="requisition_items[]" id="requisition_items" multiple="multiple"
                                    class="form-control" style="display: none;">
                                </select>
                                <div data-error-for="requisition_items"
                                    class="text-danger mt-1 error-message fs-6 fs-md-5"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="form-label fs-6 fs-md-5"><strong>Material Type Filter :</strong></label>
                                <div id="material_type_wrapper">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label fs-6 fs-md-5" for="mt-raw">Raw
                                            Material</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input material-type-filter" type="checkbox"
                                            name="material_type[]" value="Semi-Finished" id="mt-semi">
                                        <label class="form-check-label fs-6 fs-md-5" for="mt-semi">Semi Finished
                                            Material</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input material-type-filter" type="checkbox"
                                            name="material_type[]" value="Finished" id="mt-finished">
                                        <label class="form-check-label fs-6 fs-md-5" for="mt-finished">Finished
                                            Material</label>
                                    </div>
                                </div>
                                <div data-error-for="material_type"
                                    class="text-danger mt-1 error-message fs-6 fs-md-5"></div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div id="productDetailsContainer">
                                    ...
                                    <div id="productDetailsPlaceholder"
                                        ...
                                        <h5 class="text-muted mb-2 fs-6 fs-md-5">Product Details</h5>
                                        <p class="mb-0 fs-6 fs-md-5">Product details will appear here after selecting
                                            the products</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <label for="complain_images" class="fs-6 fs-md-5"><strong>Upload Images
                                        (Optional)</strong></label>
                                <div class="mb-2">
                                    <input type="file" class="form-control form-control-sm form-control-md-normal"
                                        id="complain_images" name="complain_images[]" multiple accept="image/*">
                                    <div class="form-text">
                                        <small class="text-muted fs-6 fs-md-5">
                                            <i class="ph-duotone ph-info me-1"></i>
                                            Supported formats: JPG, PNG, GIF. Maximum size per image: 1MB. You can
                                            select up to 10 images.
                                        </small>
                                    </div>
                                    <div data-error-for="complain_images"
                                        class="text-danger mt-1 error-message fs-6 fs-md-5"></div>
                                </div>

                                <!-- Image Preview Container -->
                                <div id="imagePreviewContainer" class="d-none">
                                    <h6 class="mb-2 fs-6 fs-md-5"><strong>Selected Images:</strong></h6>
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary btn-sm btn-md-normal" type="submit" id="saveUserBtn">
                        Save changes
                    </button>
                    <button class="btn btn-danger btn-sm btn-md-normal" data-bs-dismiss="modal"
                ...
                <div class="modal-body modal-body-enhanced">
                    ...
                    <div class="slip-header-enhanced">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <img src="{{ asset('assets/images/logo/logoputih.png') }}" alt="Sinar Meadow Logo" class="logo"
                ...
                function populateApprovalTracker(data) {
                    ...
                    if (managerApproved) {
                        if (bcLogs.length > 0) {
                            ...
                            if (hasRejected) {
                                if (hasPaymentProof) {
                                    steps.filter('[data-step-name="Business Controller Approval"]').addClass(
                                        'completed');
                                    bcComplete = true;
                                    progressPercent = 60;
                ...
                `);
                    ...
                    function renderImagePreviews() {
                        ...
                        if (selectedImageFiles.files.length === 0) {
                            ...
                            document.getElementById('complain_images').files = selectedImageFiles
                                .files; // pastikan input benar-benar kosong
                            return;
                        }
            ...
            `;
                    ...
                    $('#complain_images').on('change', function(e) {
                        ...
                        if (selectedImageFiles.files.length + newFiles.length > maxFiles) {
                            $('[data-error-for="complain_images"]').text(
                                `Maksimal ${maxFiles} gambar yang dapat diupload. Anda sudah memilih ${selectedImageFiles.files.length} gambar.`
                            );
                            $(this).addClass('is-invalid');
                            this.files = selectedImageFiles
                                .files; // kembalikan nilai input seperti semula
                            return;
                        }
                        ...
                        for (let i = 0; i < newFiles.length; i++) {
                            ...
                            if (file.size > maxSize) {
                                $('[data-error-for="complain_images"]').text(
                                    `File "${file.name}" terlalu besar (Max 1MB).`);
                                $(this).addClass('is-invalid');
                            ...
                            if (!allowedTypes.includes(file.type)) {
                                $('[data-error-for="complain_images"]').text(
                                    `File "${file.name}" tidak didukung. Hanya JPG, PNG, GIF.`);
                                $(this).addClass('is-invalid');
                                break; // Stop loop jika ada error
                            }
