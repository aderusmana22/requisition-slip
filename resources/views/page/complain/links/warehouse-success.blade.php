...
<head>
    ...
    <title>Warehouse Approval Confirmation - {{ config('app.name') }}</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="result-card">
        ...
        <h1 class="result-title">
            Warehouse Approval Successful!
        </h1>

        <!-- Result Message -->
        <p class="result-message">
            The warehouse approval for {{ $tracking->current_position }} has been processed successfully.
        </p>
        ...
        <div class="result-details">
            ...
            <strong>Warehouse Position:</strong> {{ $tracking->current_position }}<br>
        ...
        <div class="status-info">
            ...
            <span class="text-muted">
                @php
                    $nextTracking = App\Models\Requisition\Tracking::where('requisition_id', $requisition->id)
                ...
                @if($nextTracking)
                    This action has been recorded and the requisition will proceed to the next warehouse position: <strong>{{ $nextTracking->current_position }}</strong>
                @else
                    This action has been recorded and all warehouse approvals are now complete. The requisition process is fully approved.
                @endif
            </span>
        </div>
        ...
        <div class="status-info">
            ...
            <strong>Approved At:</strong> {{ $tracking->last_updated ? \Carbon\Carbon::parse($tracking->last_updated)->setTimezone('Asia/Jakarta')->format('d M Y, H:i:s') . ' WIB' : 'N/A' }}<br>
            @if($tracking->notes)
