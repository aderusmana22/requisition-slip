...
<head>
    ...
    <style>
        ...
        .table input[type="number"]:focus {
            border-color: #cc982f;
            box-shadow: 0 0 0 0.2rem rgba(204, 152, 47, 0.25);
            outline: none;
        }
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                                @forelse($requisition->requisitionItems as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                               ...
                                               min="0"
                                               max="{{ $item->quantity_required ?? 0 }}"
                                               step="1"
                                               style="width: 100px; margin: 0 auto;"
                                               form="warehouseApprovalForm">
                                        <input type="hidden"
        ...
        <div class="right-column">
            <div class="card action-card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('complain.warehouse.update.process') }}" method="POST" id="warehouseApprovalForm">
                        @csrf
