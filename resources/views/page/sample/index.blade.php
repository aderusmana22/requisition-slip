    ...
    @push('css')
        ...
        <style>
            @keyframes highlightRowAnim {
                0% {
                    box-shadow: inset 0 0 0 9999px rgba(37, 99, 235, 0.4);
                }
            ...
            tr.highlight-animate td {
                animation: highlightRowAnim 1.5s ease-in-out 3;
                /* Berkedip 3 kali */
                position: relative;
                /* Diperlukan agar z-index bekerja */
                z-index: 5;
                /* Pastikan highlight muncul di lapisan paling atas */
            }
        </style>
    @endpush
                        ...
                        <div id="requisition-form-details" style="display: none;">
                            <div id="main-requisition-data">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="customer_id" class="form-label">Customer Name<i
                                                class="text-danger">*</i></label>
                                        <select class="form-select select2-styled" id="customer_id"
                                    ...
                                    <div class="col-md-3">
                                        <label for="no_srs" class="form-label">SRS No.<i
                                                class="text-danger">*</i></label>
                                        <input type="text" class="form-control" id="no_srs" name="no_srs"
                                            value="{{ $generatedSrs }}" readonly>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="account" class="form-label">Account<i
                                                class="text-danger">*</i></label>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control" id="request_date"
                                            name="request_date" value="{{ date('Y-m-d') }}" readonly>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="cost_center" class="form-label">Cost Center</label>
                                        <input type="text" class="form-control" id="cost_center"
                                            name="cost_center" placeholder="e.g: 313, 202">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="objectives" class="form-label">Objectives<i
                                                class="text-danger">*</i></label>
                                        <textarea class="form-control" id="objectives" name="objectives"
                                            placeholder="e.g: New Product Development, Quality Improvement, Others: Market Testing" rows="2"></textarea>
                                ...
                                <div class="mb-3" id="product-selection-container" style="display:none;">
                                    ...
                                    <div class="form-text">Selecting a product will automatically add all its related
                                        items to the list below.</div>
                                </div>

                                <div class="mb-3" id="sample-weight-selection-container" style="display:none;">
                                    <label class="form-label fw-bold">3. Berat Sample<i
                                            class="text-danger">*</i></label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="30kg">
                                            <label class="form-check-label">30kg</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="15kg">
                                            <label class="form-check-label">15kg</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="1kg">
                                            <label class="form-check-label">1kg</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="500g">
                                            <label class="form-check-label">500gr</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="250g">
                                            <label class="form-check-label">250gr</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="5lt">
                                            <label class="form-check-label">5lt</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="1lt">
                                            <label class="form-check-label">1lt</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                name="weight_selection_option" value="500ml">
                                            <label class="form-check-label">500ml</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sample-weight-radio" type="radio"
                                                id="weight_other_radio" name="weight_selection_option"
                                                value="Lainnya">
                                            <label class="form-check-label">Lainnya</label>
                                        </div>
                                        <input type="text" class="form-control form-control-sm mt-2"
                                            id="weight_other_input" style="display: none; max-width: 200px;"
                                            placeholder="Sebutkan berat lain">
                                ...
                                <div class="table-responsive mt-4">
                                    ...
                                    <table class="table table-bordered w-100">
                                        ...
                                        <tbody id="requisition-items-tbody">
                                            <tr id="no-items-row">
                                                <td colspan="5" class="text-center">No items have been added yet.
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div id="special-order-fields" style="display: none;">
                                ...
                                <div class="row g-3 mt-1">
                                    <div class="col-md-6">
                                        <label for="end_date" class="form-label">Tanggal Selesai Sample<i
                                                class="text-danger">*</i></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="packaging-options-wrapper">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="packaging_selection_option" id="pack_tub" value="Tub">
                                                <label class="form-check-label" for="pack_tub">a. Tub</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="packaging_selection_option" id="pack_karton"
                                                    value="Karton">
                                                <label class="form-check-label" for="pack_karton">b. Karton</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="packaging_selection_option" id="pack_botol" value="Botol">
                                                <label class="form-check-label" for="pack_botol">c. Botol</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="packaging_selection_option" id="pack_jerrycan"
                                                    value="Jerrycan">
                                                <label class="form-check-label" for="pack_jerrycan">d.
                                                    Jerrycan</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                {{-- ID radio 'Lainnya' diubah --}}
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="packaging_selection_option"
                                                    id="packaging_selection_other_radio" value="Lainnya">
                                                <label class="form-check-label"
                                                    for="packaging_selection_other_radio">e. Lainnya...</label>
                                            </div>
                                        </div>

                                        {{-- ID input teks 'Lainnya' diubah --}}
                                        <input type="text" class="form-control sm-field mt-2"
                                            id="packaging_selection_other_input" style="display: none;"
                                            placeholder="Sebutkan kemasan lain...">

                                        {{-- Hidden input tetap sama, ID disesuaikan --}}
                                        <input type="hidden" name="packaging_selection" id="packaging_selection"
                                            required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control sm-field" name="sample_count"
                                            placeholder="e.g.: 2x1kg (setiap product)">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="purpose" class="form-label">Tujuan Sample<i
                                                class="text-danger">*</i></label>
                                        <textarea class="form-control sm-field" name="purpose" rows="2"
                                            placeholder="e.g.: Mengenalkan product SMII ke customer baru"></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="coa_required" id="coa_yes" value="1">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="shipment_method_option" id="ship_sales" value="Sales">
                                                <label class="form-check-label" for="ship_sales">a. Sales</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="shipment_method_option" id="ship_dhl"
                                                    value="Delivery (DHL)">
                                                <label class="form-check-label" for="ship_dhl">b. Delivery
                                                    (DHL)</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="shipment_method_option" id="ship_container"
                                                    value="Container">
                                                <label class="form-check-label" for="ship_container">c.
                                                    Container</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="shipment_method_option" id="ship_kurir" value="Kurir">
                                                <label class="form-check-label" for="ship_kurir">d. Kurir</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input sm-field" type="radio"
                                                    name="shipment_method_option" id="shipment_method_other_radio"
                                                    value="Lainnya">
                                                <label class="form-check-label" for="shipment_method_other_radio">e.
                                                    Lainnya...</label>
                                            </div>
                                        </div>
                                        ...
                                        <input type="text" class="form-control sm-field mt-2"
                                            id="shipment_method_other_input" style="display: none;"
                                            placeholder="Sebutkan metode pengiriman lain...">
                                ...
                                @if ((isset($userAccount) && $userAccount == '5302') || auth()->user()->roles()->where('name', 'super-admin')->exists())
                                    {{-- GANTI SELURUH ISI DIV "qa-fields-section" DENGAN BLOK KODE DI BAWAH INI --}}
                                    <div class="qa-fields-section mt-4">
                                        <h6 class="text-danger fw-bold">
                                            <center><i>Diisi oleh QA</i></center>
                                        </h6>
                                        <div class="mt-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="source_option" value="WH">
                                                            <label class="form-check-label">a. WH</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="source_option" value="Reference Sample">
                                                            <label class="form-check-label">b. Reference Sample</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="source_option" value="Batch Refinery">
                                                            <label class="form-check-label">c. Batch Refinery</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="source_option" value="Packing Room">
                                                            <label class="form-check-label">d. Packing Room</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                id="source_other_radio" name="source_option"
                                                                value="Lainnya">
                                                            <label class="form-check-label">e. Lainnya...</label>
                                                        </div>
                                                    </div>
                                                    <input type="text"
                                                        class="form-control form-control-sm mt-2 qa-field"
                                                        id="source_other_input"
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-sm-3 col-form-label fw-semibold">Keterangan
                                                    sample</label>
                                                <div class="col-sm-9">
                                                    <div class="mb-2">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="description_option" id="keterangan_batch_radio"
                                                                value="batch">
                                                            <label class="form-check-label"
                                                                for="keterangan_batch_radio">a. Batch / Pallet
                                                                No</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="description_option" id="keterangan_wb_radio"
                                                                value="wb">
                                                            <label class="form-check-label"
                                                                for="keterangan_wb_radio">b. WB/DEO No</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="description_option" id="keterangan_tank_radio"
                                                                value="tank">
                                                            <label class="form-check-label"
                                                                for="keterangan_tank_radio">c. Tank No</label>
                                                        </div>
                                                    </div>
                                                    <div class="input-group" id="keterangan_sample_input_wrapper"
                                                        style="display: none; max-width: 400px;">
                                                        <input type="text" class="form-control qa-field"
                                                            id="keterangan_sample_input_1"
                                                            placeholder="Masukkan nomor...">
                                                        <span class="input-group-text" id="batch_suffix_p"
                                                            style="display: none;">P</span>
                                                        <input type="text" class="form-control qa-field"
                                                            id="keterangan_sample_input_2" style="display: none;"
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control qa-field"
                                                        name="production_date" style="max-width: 200px;">
                                                </div>
                                            </div>

                                            {{-- Baris Persiapan sample --}}
                                            <div class="row mb-3 align-items-center">
                                                <label class="col-sm-3 col-form-label fw-semibold">Persiapan
                                                    sample</label>
                                                <div class="col-sm-9">
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="preparation_method_option"
                                                                value="Tidak berubah">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="preparation_method_option"
                                                                value="Rework Stencill">
                                                            <label class="form-check-label">c. Rework Stencill</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="preparation_method_option" value="Rework Label">
                                                            <label class="form-check-label">d. Rework Label</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                id="preparation_method_other_radio"
                                                                name="preparation_method_option" value="Lainnya">
                                                            <label class="form-check-label">e. Lainnya...</label>
                                                        </div>
                                                    </div>
                                                    <input type="text"
                                                        class="form-control form-control-sm mt-2 qa-field"
                                                        id="preparation_method_other_input"
                                                        style="display: none; max-width: 300px;">
                                                    <input type="hidden" name="preparation_method"
                                                ...
                                                <div class="col-sm-9">
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input qa-field" type="radio"
                                                                name="sample_notes_option" value="Tempel sticker">
                                                            <label class="form-check-label">a. Tempel sticker</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input qa-field" type="radio"
                                                                id="sample_notes_other_radio"
                                                                name="sample_notes_option" value="Lainnya">
                                                            <label class="form-check-label">b. Lainnya...</label>
                                                        </div>
                                                    </div>
                                                    <input type="text"
                                                        class="form-control form-control-sm mt-2 qa-field"
                                                        id="sample_notes_other_input"
                                                        style="display: none; max-width: 300px;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white" id="viewModalLabel"><i
                            class="ph-bold ph-file-text me-2"></i>Sample Requisition Details</h5>
                    <button type="button" class="btn-close btn-close-white m-0 fs-5" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body p-4" style="background-color: #f8f9fa;">
                    ...
                    <div class="card view-modal-card">
                        <div class="card-header view-modal-card-header">
                            <h5 class="fw-bold text-primary mb-3"><i class="ph-bold ph-identification-card me-2"></i>
                                Requisition Details</h5>
                        </div>
                    ...
                    <div class="card view-modal-card">
                        <div class="card-header">
                            <h5 class="fw-bold text-primary mb-3"><i class="ph-bold  ph-list me-2"></i>Requested Item
                                List</h5>
                        </div>
                    ...
                    <div class="card view-modal-card" id="view-special-order-section" style="display: none;">
                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                <div class="col-md-4"><label class="text-muted">Sample Completion Date</label>
                                    <p class="fs-6 fw-semibold" id="view_requested_date">-</p>
                                </div>
                                <div class="col-md-4"><label class="text-muted">Sample Weight</label>
                                    <p class="fs-6 fw-semibold" id="view_weight_selection">-</p>
                                </div>
                                <div class="col-md-4"><label class="text-muted">Sample Packaging</label>
                                    <p class="fs-6 fw-semibold" id="view_packaging_selection">-</p>
                                </div>
                                <div class="col-md-4"><label class="text-muted">Number of Samples</label>
                                    <p class="fs-6 fw-semibold" id="view_sample_count">-</p>
                                </div>
                                <div class="col-md-4"><label class="text-muted">COA Required?</label>
                                    <p class="fs-6 fw-semibold" id="view_coa_required">-</p>
                                </div>
                                <div class="col-md-4"><label class="text-muted">Shipment Method</label>
                                    <p class="fs-6 fw-semibold" id="view_shipment_method">-</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card view-modal-card" id="view-qa-section" style="display: none;">
                        <div class="card-header view-modal-card-header">
                            <h5 class="fw-bold text-primary mb-3"><i class="ph-bold ph-test-tube me-2"></i> QA/QM
                                Details</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-4">
                    ...
                    <div class="card view-modal-card">
                        <div class="card-header view-modal-card-header">
                            <h5 class="fw-bold text-primary mb-3"><i class="ph-bold ph-path me-2"></i> Approval &
                                Process Tracking</h5>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="tracker-container" id="approval-tracker-container">
                                ...
                                <div class="tracker-step" data-step-name="Ready for Dispatch">
                                    <div class="tracker-icon"><i class="ph-bold ph-truck fs-6"></i></div>
                                    <div class="tracker-label">Dispatch</div>
                                    <div class="tracker-details"></div>
                                </div>
                    ...
                    <div class="card view-modal-card">
                        <div class="card-header view-modal-card-header">
                            <h5 class="fw-bold text-primary mb-3"><i
                                    class="ph-bold ph-clock-counter-clockwise me-2"></i> Requisition History</h5>
                        </div>
                        <div class="card-body p-4">
        ...
        <script>
            ...
            function successMessage(message) {
                Swal.fire({
                    ...
                    timer: 1500,
                    showConfirmButton: true
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                });
            }
                            ...
                            setTimeout(() => {
                                $('html, body').animate({
                                    scrollTop: $(row).offset().top -
                                        150 // Scroll dengan offset header
                                }, 500);
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                            }, 500);
                        }
...
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                ...
                $('#sub_category').on('change', function() {
                    ...
                    // Reset Tampilan
                    $('#product-selection-container, #material-type-selection-container, #product-selection-container-fg, #sample-weight-selection-container, #requested-item-list-container, #special-order-fields, #btn-add-items-master, #print-batch-container')
                        .hide();
                    ...
                    if ($('#sampleForm').attr('data-mode') === 'create') {
                        $('#requisition-items-tbody').html(
                            `<tr id="no-items-row"><td colspan="${colspan}" class="text-center">No items have been added yet.</td></tr>`
                            );
                    }
                    ...
                    if (selectedSubCategory === 'Packaging') {
                        $('#product-selection-container, #material-type-selection-container, #requested-item-list-container, #print-batch-container')
                            .slideDown();
                        ...
                        $.ajax({
                            ...
                            success: function(masters) {
                                ...
                                productSelect.empty();
                                masters.forEach(m => productSelect.append(new Option(
                                    `[${m.item_master_code}] ${m.item_master_name}`, m
                                    .id)));
                        ...
                        'Special Order') {
                        $('#product-selection-container-fg, #requested-item-list-container, #btn-add-items-master')
                            .slideDown();
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            function submitForm(formData) {
                                ...
                                let url = (mode === 'edit') ? `/sample-form/${id}` :
                                    "{{ route('sample-form.store') }}";
                                if (mode === 'edit') {
                                    formData.append('_method', 'PUT');
                                }
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
...
=======
                                            ...
                                            if (openFormId) {
                                                setTimeout(function() {
                                                    const qaButton = $(
                                                        `.btn-qa-form[data-id="${openFormId}"]`
                                                        );
                                                    if (qaButton.length) {
                                                        qaButton.click();
                                                    } else {
                                                        console.warn(
                                                            `Tombol QA untuk requisition ID ${openFormId} tidak ditemukan.`
                                                            );
                                                    }
                                                }, 500);
                                            }
                                    ...
                                    error: function(xhr) {
                                        if (xhr.status === 422) {
                                            ...
                                            if (itemErrorMessages.size > 0) {
                                                $('#items_error').show().html(Array.from(
                                                    itemErrorMessages).join('<br>'));
                                            }
                                        } else {
                            ...
                            // Logika untuk print_batch (jika ada) dipindahkan ke sini juga
                            if (currentSubCategory === 'Packaging' && mode === 'create' && $(form).data(
                                    'is-fresh-creation')) {
                                Swal.fire({
                                    title: 'Print Batch Number',
                                    text: "Apakah Anda ingin mencetak Batch Number untuk requisition ini?",
...
=======
                                ...
                                if (currentSubCategory === 'Packaging' && mode === 'create' && !$(form)
                                    .data('is-fresh-creation')) {
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                                    formData.append('print_batch', '0');
                                }
...
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                ...
                $('input[name="description_option"]').on('change', function() {
                    ...
                    if (selectedType === 'batch') {
                        ...
                        keteranganInput1.attr('placeholder', selectedType === 'wb' ? 'WB/DEO No...' :
                            'Tank No...');
                        keteranganInput2.hide();
                        batchSuffix.hide();
                    }
...
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                            ...
                            const colspan = isPackaging ? 6 : 5;
                            itemTbody.html(
                                `<tr id="no-items-row"><td colspan="${colspan}" class="text-center">No items found.</td></tr>`
                                );
                        }
                        applyMaterialTypeFilter();
                    }
                ...
                function populateViewForm(data) {
                    ...
                    $('#view_request_date').text(new Date(data.request_date).toLocaleDateString('en-GB', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric'
                    }) || '-');
                    ...
                    if (data.requisition_items && data.requisition_items.length > 0) {
                        data.requisition_items.forEach(item => {
                            ...
                            const newRow =
                                `<tr>${materialTypeCell}<td>${itemCode}</td><td>${itemName}</td><td>${unit}</td><td class="text-center">${item.quantity_required}</td><td class="text-center">${item.quantity_issued || '-'}</td></tr>`;
                            viewItemTbody.append(newRow);
                        });
                    } else {
                        const colspan = isPackaging ? 6 : 5;
                        viewItemTbody.html(
                            `<tr><td colspan="${colspan}" class="text-center">No items have been added.</td></tr>`);
                    }
                    ...
                    if (data.sub_category === 'Special Order' && data.requisition_special) {
                        const special = data.requisition_special;
                        $('#view_requested_date').text(special.requested_date ? new Date(special.requested_date)
                        ...
                        if (special.source) {
                            ...
                            $('#view_production_date').text(special.production_date ? new Date(special.production_date)
                                .toLocaleDateString('en-GB', {
                                    day: 'numeric',
                                    month: 'long',
                                    year: 'numeric'
...
=======
                    ...
                    `<span class="badge fs-6 rounded-pill ${badgeClass}">${status}</span>`);
>>>>>>> 715dd61 (Refactor code structure for improved readability and maintainability)
                    ...
                    if (data.sequence_tracking && data.status !== 'Rejected' && data.status !== 'Recalled') {
                        data.sequence_tracking.forEach((stepName, index) => {
                            ...
                            if (stepNameLower.includes('qa') || stepNameLower.includes('qm')) icon =
                                'ph-clipboard-text';
                    ...
                    steps.forEach(step => {
                        trackerHtml +=
                            `<div class="tracker-step" data-step-id="${step.id}"><div class="tracker-icon"><i class="ph-bold ${step.icon} fs-6"></i></div><div class="tracker-label">${step.label}</div><div class="tracker-details"></div></div>`;
                    });
                    ...
                    if (data.requester && data.created_at) {
                        ...
                        submittedStep.addClass('completed').find('.tracker-details').html(
                            `<div class="tracker-user text-primary">${data.requester.name}</div><div class="tracker-date text-dark">${creationDate}</div>`
                            );
                        ...
                        data.approval_logs.forEach(log => {
                            ...
                            if (stepElement.length > 0) {
                                if (log.status === 'Approved') {
                                    const approvalDate = new Date(log.updated_at).toLocaleString('en-GB', {
                                        day: 'numeric',
                                        month: 'short',
                                        year: 'numeric',
                                        hour: '2-digit',
                                    ...
                                    stepElement.addClass('completed').find('.tracker-details').html(
                                        `<div class="tracker-user text-primary">${log.approver.name}</div><div class="tracker-date text-dark">${approvalDate}</div>`
                                        );
                                    const stepIndex = steps.findIndex(s => s.id === `approver_${log.level}`);
                                    lastCompletedIndex = Math.max(lastCompletedIndex, stepIndex);
                                } else if (log.status === 'Rejected') {
                                    const rejectionDate = new Date(log.updated_at).toLocaleString('en-GB', {
                                        day: 'numeric',
                                        month: 'short',
                                        year: 'numeric',
                                        hour: '2-digit',
                                    ...
                                    stepElement.addClass('rejected').find('.tracker-details').html(
                                        `<div class="tracker-user text-danger">${log.approver.name}</div><div class="tracker-date text-dark">${rejectionDate}</div>`
                                        );
                                }
                            }
                        });
...
=======
                                ...
                                if (stepId) {
                                    ...
                                    const stepLabel = stepElement.find('.tracker-label')
                                .text(); // Ambil nama role dari label

                                    // Tentukan nama user
                                    let userName = tracking
                                    .current_position; // Ini adalah Nama User (cth: "Head WH")
                                    if (stepLabel.toLowerCase().includes('qa') || stepLabel.toLowerCase()
                                        .includes('qm')) {
                                        userName = 'QA/QM HSE Team';
                                    }

                                    const completionDate = new Date(tracking.last_updated).toLocaleString(
                                        'en-GB', {
                                            day: 'numeric',
                                            month: 'short',
                                            year: 'numeric',
                                    ...
                                    stepElement.addClass('completed').find('.tracker-details').html(
                                        `<div class="tracker-user text-primary">${userName}</div><div class="tracker-date text-dark">${completionDate}</div>`
                                        );
                    ...
                    if (data.status === 'Completed') {
                        ...
                        const completionDate = new Date(data.updated_at).toLocaleString('en-GB', {
                            day: 'numeric',
                            month: 'short',
                            year: 'numeric',
                            hour: '2-digit',
                        ...
                        completedStep.find('.tracker-details').html(
                            `<div class="tracker-user text-primary">${data.requester.name}</div><div class="tracker-date text-dark">${completionDate}</div>`
                            );
                        $('.tracker-step').addClass('completed');
                        lastCompletedIndex = steps.length - 1;
                    } else if (data.status === 'Recalled') {
                        const submittedStep = $(`.tracker-step[data-step-id="submitted"]`);
                        const recallDate = new Date(data.updated_at).toLocaleString('en-GB', {
                            day: 'numeric',
                            month: 'short',
                            year: 'numeric',
                            hour: '2-digit',
                        ...
                        submittedStep.addClass('rejected').find('.tracker-details').html(
                            `<div class="tracker-user text-danger">${data.requester.name}</div><div class="tracker-date text-dark">${recallDate}</div>`
                            );
                    } else if (!isRejected) {
                    ...
                    if (data.history && data.history.length > 0) {
                        data.history.forEach(log => {
                            let badgeClass = 'badge-created',
                                avatarClass = 'avatar-created';
                            const action = log.action.toLowerCase();
                            if (action.includes('approved not review')) {
                                badgeClass = 'badge-approved';
                                avatarClass = 'avatar-approved';
                            } else if (action.includes('approved with review')) {
                                badgeClass = 'badge-review';
                                avatarClass = 'avatar-review';
                            } else if (action.includes('rejected') || action.includes('recalled')) {
                                badgeClass = 'badge-rejected';
                                avatarClass = 'avatar-rejected';
                            } else if (action.includes('completed step')) {
                                badgeClass = 'badge-process';
                                avatarClass = 'avatar-process';
                            }
                            let avatarHtml = '',
                                actorInitial = log.actor ? log.actor.charAt(0).toUpperCase() : '?';
                            if (log.avatar) {
                            ...
                            '';
                            const logDate = new Date(log.timestamp).toLocaleString('en-GB', {
                                day: 'numeric',
                                month: 'short',
                                year: 'numeric',
                                hour: '2-digit',
                            ...
                            const historyItem =
                                `<li class="list-group-item history-item"><div class="history-avatar ${avatarClass}">${avatarHtml}</div><div class="history-content"><div class="history-actor">${log.actor}</div>${notesHtml}</div><div class="history-meta"><div class="history-badge ${badgeClass}">${log.action}</div><div class="history-timestamp">${logDate}</div></div></li>`;
                ...
                $(document).on('click', '.btn-duplicate-requisition', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#sampleForm').attr('data-mode', 'create').removeAttr(
                            'data-id'); // Penting: set mode ke 'create'
                            ...
                            $('#sub_category').prop('disabled',
                            false); // Memungkinkan ubah sub-category

                            // Tombol harus kembali ke "Save" (store)
                            $('#saveSampleBtn').text('Save as New Requisition').prop('disabled',
                                false);
                            ...
                            `,
                                ...
                                if (confirmResult.isConfirmed) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            if (response.success) {
                                                Swal.fire('Recalled!', response
                                                    .message, 'success');
                                                table.ajax.reload(null, false);
                                            }
                                        },
                                        error: function(xhr) {
                                            Swal.fire('Gagal!', xhr.responseJSON
                                                ?.message ||
                                                'Terjadi kesalahan.', 'error');
                                        },
                                        complete: function() {
                                            button.html(originalHtml).prop(
                                                'disabled', false);
                                        }
                                    });
                                }
