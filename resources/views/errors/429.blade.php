...
<body>
    ...
    <div class="error-container">
        <div class="icon-wrapper">
            <div class="icon">
                <i class="ph-fill ph-traffic-sign"></i>
            </div>
        </div>
        ...
        <p class="error-message">
            Whoa, slow down! You've made too many requests in a short period. Please wait a moment before trying again.
        </p>
        ...
        <div class="error-details">
            ...
            <ul class="error-details-list">
                ...
                <li>
                    ...
                    Rate limiting protects our servers
                </li>
            </ul>
        </div>
        ...
        <div class="help-text">
            Still having issues? <a href="mailto:support@sinarmeadow.com">Contact support</a>
        </div>
    </div>
</body>
</html>
