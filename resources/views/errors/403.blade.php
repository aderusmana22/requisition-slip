...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            You don't have permission to access this resource. This action requires specific privileges that your account doesn't have.
        </p>
        ...
        <div class="error-details">
            ...
            <ul class="error-details-list">
                <li>
                    <i class="ph-duotone ph-shield-slash"></i>
                ...
                <li>
                    ...
                    You need administrator approval to access this
                </li>
            </ul>
        </div>
        ...
        <div class="help-text">
            Need access? Contact your <a href="mailto:support@sinarmeadow.com">system administrator</a>
        </div>
    </div>
</body>
</html>
