...
<head>
    ...
    <style>
        ...
        .btn-approve { background: #28a745; border: 1px solid #28a745; }
        .btn-reject { background: #dc3545; border: 1px solid #dc3545; }
        .btn-review { background: #cc982f; border: 1px solid #cc982f; }
        .btn-process { background: #007bff; border: 1px solid #007bff; }
        .email-footer { background: #343a40; color: #adb5bd; padding: 30px; text-align: center; font-size: 12px; border-top: 4px solid #cc982f; }
    </style>
</head>
<body>
        ...
        <div class="email-content">
            <div class="greeting">
                ...
                @if(isset($mail_type) && $mail_type === 'completed_notification')
                    Your <strong>{{ $requisition->sub_category ?? 'Requisition' }}</strong> has been fully processed and is now <strong>COMPLETED</strong>.
                ...
                @else
                    A new <strong>{{ $requisition->sub_category ?? 'Free Goods Request' }}</strong> requires your review. Please check the details below.
                @endif
            </div>
