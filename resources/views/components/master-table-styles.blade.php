{{--
==========================================================
Master TABLE STYLES COMPONENT
==========================================================
Include this component to apply consistent master management table styling
Usage: @include('components.master-table-styles')
...
• #masterable                 → Main table dengan gold theme
...
@push('css')
    <link rel="stylesheet" href="{{ asset('assets/css/master-table-styles.css') }}">
